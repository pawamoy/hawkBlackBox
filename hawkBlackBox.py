...
stabilizer0 = Stabilizer(0, {
    ...
    (3, 1, 0, 0): Probability(39, 52, 8, 0,   (0, 75, 18, 7),  78),
    (3, 0, 1, 0): Probability(41, 40, 13, 6,  (0, 60, 25, 15), 96),
    (3, 0, 0, 1): Probability(43, 43, 0, 14,  (0, 71, 8, 21),  123),
    (2, 2, 0, 0): Probability(27, 55, 17, 1,  (0, 67, 26, 7),  112),
    (2, 1, 1, 0): Probability(29, 42, 23, 6,  (0, 54, 32, 14), 127),
    (2, 1, 0, 1): Probability(30, 45, 10, 15, (0, 58, 18, 24), 154),
    (2, 0, 2, 0): Probability(30, 29, 29, 12, (0, 40, 40, 21), 146),
    (2, 0, 1, 1): Probability(31, 31, 16, 22, (0, 43, 25, 32), 173),
    (2, 0, 0, 2): Probability(33, 33, 0, 33,  (0, 50, 8, 42),  196),
    (1, 3, 0, 0): Probability(15, 57, 27, 1,  (0, 61, 32, 7),  143),
    (1, 2, 1, 0): Probability(15, 44, 34, 7,  (0, 49, 38, 13), 162),
    (1, 2, 0, 1): Probability(16, 47, 20, 17, (0, 52, 26, 22), 185),
    (1, 1, 2, 0): Probability(15, 31, 40, 14, (0, 36, 45, 19), 177),
    (1, 1, 1, 1): Probability(16, 33, 27, 24, (0, 38, 32, 29), 204),
    (1, 1, 0, 2): Probability(18, 35, 11, 36, (0, 41, 18, 41), 227),
    (1, 0, 3, 0): Probability(16, 16, 48, 20, (0, 22, 52, 26), 196),
    (1, 0, 2, 1): Probability(17, 17, 34, 32, (0, 23, 40, 37), 223),
    (1, 0, 1, 2): Probability(19, 18, 18, 45, (0, 25, 25, 50), 246),
    (1, 0, 0, 3): Probability(20, 20, 0, 60,  (0, 29, 8, 62),  270),
    ...
    (0, 2, 1, 1): Probability(0, 35, 40, 26,  (0, 0, 55, 45),  235),
